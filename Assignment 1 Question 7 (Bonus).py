...
n = float(input("Enter required months: "))
ALLOWANCE = 20000
R = 0.5
sf = 0
months = n+1

def bank_acc(savings,months,sf,cost,R=0.5,ALLOWANCE=20000):
...
while (n<months):
    ...
    while(savings<cost):
        savings, months = bank_acc(savings, months, sf,cost)

    
print(f"The required saving fraction is: {sf}")